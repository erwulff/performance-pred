...
@click.option(
    "--known_epochs",
    default=3,
    help="Number of epochs needed for the performance prediction.",
)
@click.option(
    "--total_epochs",
    default=12,
    help="Number of epochs up to which the most promising configurations will be trained",
)
@click.option(
    "--model_file",
    default="model.joblib",
    help="Joblib file storing a trained performance predictor",
)
@click.option(
    "--x_scaler_file",
    default="x_scaler.joblib",
...
@click.option(
    "--n_samples",
    default=100,
    help="Number of configurations that will be partially trained",
)
@click.option(
    "--presults_file",
    default="presults.csv",
    help="File to store the results of partially trained configs",
)
@click.option(
    "--fresults_file",
    default="fresults.csv",
    help="File to store the results of totally trained configs",
)
def main(
    known_epochs: int,
    total_epochs: int,
